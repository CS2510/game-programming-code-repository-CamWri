class PlayerCharacterSquareGameObject extends PlayerCharacterGameObject{
    constructor(){
        ...
        this.addComponent(new PlayerComponent(), {abilities: {"Space": MoveActionComponent, "Digit1": SlashActionComponent, "Digit2": FireballActionComponent, "Digit3": PummelActionComponent, "Digit4": WhirlwindActionComponent}})
    }
}