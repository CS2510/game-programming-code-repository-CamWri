class PlayerCharacterSquareGameObject extends PlayerCharacterGameObject{
    constructor(statusEffects){
        ...
        this.addComponent(new Polygon, {points: [new Vector2(-20, -20), new Vector2(-20, 20), new Vector2(20, 20), new Vector2(20, -20)], fillStyle: "green", strokeStyle: "black", lineWidth: 5})
