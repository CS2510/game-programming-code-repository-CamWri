class BattleScene extends Scene{
    constructor(){
        ...
        let camera = this.gameObjects[0]
        //camera.addComponent(new CameraMoveComponent())
        ...
        let turnIndicatiorUI = this.instantiate(new TurnIndicatorUIGameObject(), new Vector2(0, 0))
        ...
        let ActionUIModule = this.instantiate(new GameObject("Action UI Parent Tool Tip", {layer: "UI"}), new Vector2(750, 750))
        ...
        let ActionUI1Name = this.instantiate(new GameObject("", {layer: "UI"}),new Vector2(-35, 0))
