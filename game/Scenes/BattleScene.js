class BattleScene extends Scene{
    constructor(){
        super()
        //Players
        let playerSquare = this.instantiate(new PlayerCharacterSquareGameObject(), new Vector2(400, 175))
        let playerSquare2= this.instantiate(new PlayerCharacterSquareGameObject(), new Vector2(400, 625))
        ...
        this.instantiate(new TurnManagerGameObject([playerSquare, playerSquare2], [enemy1, enemy2, enemy3, enemy4, enemy5], turnIndicatior), new Vector2(0, 0))
