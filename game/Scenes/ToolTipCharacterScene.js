class ToolTipCharacterScene extends Scene{
    constructor(){
        ...
        let toolTipParent = this.instantiate(new GameObject("Parent Tool Tip"), new Vector2(200, 200))
        toolTipParent.addComponent(new ManageCharacterUIToolTipComponent())

        let toolTip = this.instantiate(new ToolTipGameObject(new Vector2(100, 100)), new Vector2(0, 0))
        toolTip.transform.setParent(toolTipParent.transform)

        let healthText = this.instantiate(new GameObject("Health Text Game Object"),new Vector2(-90, -75))
        ...
        let statusEffectsText = this.instantiate(new GameObject("Status Effects Text Game Object"),new Vector2(-90, -30))
